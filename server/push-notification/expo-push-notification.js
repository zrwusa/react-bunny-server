...
async function sendMessageThenGetReceiptIds(message,tokens) {
    let push_tokens;
    if(tokens){
        push_tokens = tokens;
    }else {
    ...
    // return {
    //     tickets: [
    //         {status: 'ok', id: '1b070ff7-24d6-45a9-97a9-259c44293a97'},
    //         {
    //             status: 'error',
    //             message: '"ExponentPushToken[oT1TDBCO7jtDytecDBmKXX]" is not a registered push notification recipient',
    //             details: {error: 'DeviceNotRegistered'}
    //         }
    //     ],
    //     receiptIds: ['1b070ff7-24d6-45a9-97a9-259c44293a97']
    // }
}
